# Creating a Dataset with Noise and Outliers for Linear Regression

Below I'll create a synthetic dataset with noise and outliers, implement basic linear regression, and then improve it using gradient descent.
...
## Step 2: Basic Linear Regression (Ordinary Least Squares)
...
## Step 4: Improving Gradient Descent with Feature Scaling and More Iterations
...
## Step 5: Adding Regularization (Optional - for handling outliers better)
...
1. Creating a synthetic dataset with noise and outliers
2. Implementing basic linear regression (OLS)
3. Implementing gradient descent for linear regression
4. Improving gradient descent with feature scaling
5. Adding regularization (Ridge regression) to handle outliers better

The plots will show how each method performs against the true relationship and how they handle the outliers differently.